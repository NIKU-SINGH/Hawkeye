...
function index() {
  return (
    <div className="flex h-20 p-2 m-2 w-1/2 bg-gray-200 rounded-lg hover:cursor-pointer hover:shadow-slate-600">
      {/* Logo */}
      <div>
        <Image
          ...
          height={1200}
          width={1200}
          className="h-16 w-16 rounded-lg hover:shadow-lg "
        />
      </div>
      {/* Information */}
      <div className="mx-2">
